...
/** 
 * parse_command - This will determine the type of command.
...
int parse_command(char *command)
{
	...
	/* @check_path - will check whether a command has been found in the PATH */
...
/**
 * execute_command - This will execute a command based on it's type.
 * @tokenized_command: the command's tokenized form (ls -l == {ls, -l, NULL})
...
/**
 * check_path - This will check if a command is found in the PATH
...
/**
 * get_func - This will retrieve a function based on the command given
 * and a mapping.
 * @command: The string to check against the mapping.
 *
 * Return: pointer to the proper function, or null if fail.
 */
...
/**
 * _getenv - This will get the value of an environment variable
